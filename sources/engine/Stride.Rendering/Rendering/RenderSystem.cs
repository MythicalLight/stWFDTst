...
namespace Stride.Rendering
{
    ...
    public class RenderSystem : ComponentBase
    {
        ...
        private readonly ConcurrentPool<List<RenderNodeFeatureReference>> sortedRenderNodePool = new ConcurrentPool<List<RenderNodeFeatureReference>>(() => new List<RenderNodeFeatureReference>());
